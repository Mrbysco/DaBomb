...
public class BombFish extends ThrowableItemProjectile {

	public BombFish(EntityType<? extends BombFish> entityType, Level level) {
	...
	public BombFish(PlayMessages.SpawnEntity spawnEntity, Level level) {
		this(BombRegistry.BOMB_FISH.get(), level);
	}
