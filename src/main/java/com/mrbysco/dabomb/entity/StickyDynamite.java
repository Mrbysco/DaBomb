...
public class StickyDynamite extends ThrowableItemProjectile {
	...
	protected void explode() {
		this.level().explode(this, this.getX(), this.getY(0.0625D) + 0.5F, this.getZ(), BombConfig.COMMON.stickyDynamiteRadius.get().floatValue(), Level.ExplosionInteraction.TNT);
	}
